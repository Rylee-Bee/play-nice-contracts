...
| `contract-attestation` | Contract Attestation | 1.3.0 | canonical | Full gate: freshness-verified source (incl. automatic-mode equivalence), receipt + hash + task-impact attestation, then OPERATIONAL COMMITMENT: ACTIVE before mutation |
...
| `room` | Room | 1.1.1 | canonical | Uniform five-endpoint contract a front door uses to render and act on any room |
