...
<!-- contract-receipt: timber-compass-willow -->
...
Attention economics (Attention and Focus) demand a small first view; honesty (Human Reliability) forbids hiding truth. Progressive disclosure is the reconciliation: organize entry into attention without deleting capability.
